...
(assert (=> true (not (or false false false false false false false false false false false false false false false (not (= (+ (* 1 f144@1) (* 1 f145@1) 1) 0))))))
(push 1)
(check-sat)
(pop 1)
(assert (=> true (> (+ (* 1 f148@1) (- 2)) 0)))
(check-sat)
(get-unsat-core)
